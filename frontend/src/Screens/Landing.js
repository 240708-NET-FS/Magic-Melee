    ...
    return (
        ...
        <div>
            <div style={{padding: 75}}>
                ...
                <div>
                    <LandingButton radius={1} color={'#7634bb'} text={'Login'} size={200}
                                   onPress={onPressLogin}/>
                    <LandingButton radius={1} color={'black'} text={'Create Account'}
                                   size={200} borderColor={'#7634bb'}
                                   borderWidth={2}
                                   onPress={onPressCreate}/>
                    <LandingButton radius={1} color={'#8b9a9d'} text={'Continue As Guest'}
                                   size={200}
